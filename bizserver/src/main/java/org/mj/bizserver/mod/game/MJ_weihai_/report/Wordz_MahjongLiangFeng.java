 ...
 * 麻将亮风词条
 */
public class Wordz_MahjongLiangFeng implements IWordz {
    /**
     * 用户 Id
     */
     ...
     */
    public Wordz_MahjongLiangFeng(int userId, MahjongLiangFeng.KindDef kind, Map<MahjongTileDef, Integer> counterMap) {
        _userId = userId;
        _kind = kind;
    ...
    public GeneratedMessageV3 buildResultMsg() {
        return MJ_weihai_Protocol.MahjongLiangFengResult.newBuilder()
    ...
    public GeneratedMessageV3 buildBroadcastMsg() {
        return MJ_weihai_Protocol.MahjongLiangFengBroadcast.newBuilder()
            .setUserId(_userId)
            .setMahjongLiangFeng(buildMahjongLiangFengMsg())
            .build();
    }
