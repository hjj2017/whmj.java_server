 ...
 * 麻将补风指令处理器
 */
public final class MahjongBuFengCmdHandler extends AbstractInGameCmdHandler<MJ_weihai_Protocol.MahjongBuFengCmd>
    implements ICmdHandler<MJ_weihai_Protocol.MahjongBuFengCmd> {
    ...
    public void handle(
        ...
        int remoteSessionId,
        int fromUserId,
        MJ_weihai_Protocol.MahjongBuFengCmd cmdObj) {
        // 将复杂工作交给代理, 我只执行省心的调用
